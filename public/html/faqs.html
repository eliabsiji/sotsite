...
<!-- Mirrored from duruthemes.com/demo/html/pozo/dark/faqs.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 31 Oct 2023 23:41:59 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown"> <a class="nav-link active dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">Pages <i class="fa fa-angle-down"></i></a>
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="faqs.html" class="dropdown-item active"><span>Faq</span></a></li>
                    ...
                    <div class="col-md-8">
                        <ul class="accordion-box clearfix">
                            <li class="accordion block">
                                <div class="acc-btn size-20">Are you open for new projects or commissions?</div>
                            ...
                            <li class="accordion block">
                                <div class="acc-btn size-20">Do you offer photography work abroad?</div>
                                <div class="acc-content">
                                    <div class="content">
                                        <div class="text">Lorem ut nisl quam nestibulum ac quam nec odio elementum sceisue the aucan ligula. Orci varius natoque penatibus et magnis dis parturient monte nascete ridiculus mus nellentesque habitant morbine.</div>
                                    </div>
                            ...
                            <li class="accordion block">
                                <div class="acc-btn size-20">Where are you currently located?</div>
                                <div class="acc-content">
                                    <div class="content">
                                        <div class="text">Lorem ut nisl quam nestibulum ac quam nec odio elementum sceisue the aucan ligula. Orci varius natoque penatibus et magnis dis parturient monte nascete ridiculus mus nellentesque habitant morbine.</div>
                                    </div>
                            ...
                            <li class="accordion block">
                                <div class="acc-btn size-20">Are you open for freelance/contract work?</div>
                                <div class="acc-content">
                                    <div class="content">
                                        <div class="text">Lorem ut nisl quam nestibulum ac quam nec odio elementum sceisue the aucan ligula. Orci varius natoque penatibus et magnis dis parturient monte nascete ridiculus mus nellentesque habitant morbine.</div>
                                    </div>
