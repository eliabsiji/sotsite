            ...
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="swiper-slide-block">
                            <div class="swiper-slide-block-img" data-swiper-parallax-y="70%">
                                <a href="#"><img src="<?php echo e(asset('html/images/slider/27.jpg')); ?>" alt=""></a>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="swiper-slide-block">
                            <div class="swiper-slide-block-img" data-swiper-parallax-y="70%">
                                <a href="#"> <img src="<?php echo e(asset('html/images/gallery/bgshade.jpg')); ?>" alt=""> </a>
                            </div>
                            <div class="swiper-slide-block-text">
                                <h2 data-swiper-parallax-x="-60%" class="next-main-title">ADRAH STUDIOS</h2>
                                <h3 data-swiper-parallax-x="-50%" class="next-main-subtitle">Birthdays</h3>
                                <p data-swiper-parallax-x="-40%" class="next-paragraph">...with us, marking the day is our delight</p>
                                <a data-swiper-parallax-x="-30%" class="next-link" href="#" target="">Reach us now</a> <span data-swiper-parallax-y="60%" class="next-number">4</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="swiper-slide-block">
                            <div class="swiper-slide-block-img" data-swiper-parallax-y="70%">
                                <a href="#"> <img src="<?php echo e(asset('html/images/gallery/33.jpg')); ?>" alt=""> </a>
                            </div>
                            <div class="swiper-slide-block-text">
                                <h2 data-swiper-parallax-x="-60%" class="next-main-title">ADRAH STUDIOS</h2>
                                <h3 data-swiper-parallax-x="-50%" class="next-main-subtitle">Birthdays</h3>
                                <p data-swiper-parallax-x="-40%" class="next-paragraph">...with us, marking the day is our delight</p>
                                <a data-swiper-parallax-x="-30%" class="next-link" href="#" target="">Reach us now</a> <span data-swiper-parallax-y="60%" class="next-number">5</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\sotsite\resources\views/inc/sidebar.blade.php ENDPATH**/ ?>