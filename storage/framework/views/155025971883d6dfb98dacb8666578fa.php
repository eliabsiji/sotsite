            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="#" role="button"
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo e(route('portfolio.weddings')); ?>" class="dropdown-item"><span>Weddings</span></a></li>
                        <li><a href="<?php echo e(route('portfolio.events')); ?>" class="dropdown-item"><span>Events</span></a></li>
                        <li><a href="<?php echo e(route('portfolio.portraits')); ?>" class="dropdown-item"><span>Portraits</span></a></li>
                ...
                <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">More <i class="fa fa-angle-down"></i></a>
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo e(route('faqs')); ?>" class="dropdown-item"><span>Faq</span></a></li>
                    </ul>
                </li>
            </ul>
        </div>
...
<?php /**PATH C:\xampp\htdocs\adrahsite\resources\views/inc/navbar.blade.php ENDPATH**/ ?>