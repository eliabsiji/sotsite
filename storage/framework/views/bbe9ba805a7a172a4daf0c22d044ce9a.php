...
<!-- Mirrored from www.okler.net/previews/porto/10.0.0/demo-church.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Nov 2023 13:19:51 GMT -->
<head>
					...
					<div class="header-top">
						<div class="container">
							<div class="row justify-content-between">
								<div class="col-auto">
									<p class="alternative-font-4 mb-0"><strong class="text-color-dark">Porto Church, A Place to Belong!</strong></p>
								</div>
										...
										<div class="header-nav-main header-nav-main-square header-nav-main-dark-text header-nav-main-effect-1 header-nav-main-sub-effect-1">
											<nav class="collapse">
												<ul class="nav nav-pills" id="mainNav">
													<li>
														<a class="nav-link active" href="<?php echo e(asset('html/demo-church.html')); ?>">
															Home
														</a>
													</li>
													<li class="dropdown dropdown-full-color dropdown-primary">
														<a class="dropdown-item dropdown-toggle" href="<?php echo e(asset('html/demo-church-about-us.html')); ?>">
															About Us
														</a>
														<ul class="dropdown-menu">
															<li>
																<a class="dropdown-item" href="<?php echo e(asset('html/demo-church-about-us.html')); ?>">Overview</a>
															</li>
															<li>
																<a class="dropdown-item" href="<?php echo e(asset('html/demo-church-about-us-staff.html')); ?>">Staff</a>
															</li>
															<li>
																<a class="dropdown-item" href="<?php echo e(asset('html/demo-church-about-us-locations.html')); ?>">Locations</a>
															</li>
														</ul>
													</li>
													<li>
														<a class="nav-link" href="<?php echo e(asset('html/demo-church-sermons.html')); ?>">
															Sermons
														</a>
													</li>
													<li>
														<a class="nav-link" href="<?php echo e(asset('html/demo-church-events.html')); ?>">
															Events
														</a>
													</li>
													<li>
														<a class="nav-link" href="<?php echo e(asset('html/demo-church-gallery.html')); ?>">
															Gallery
														</a>
													</li>
													<li>
			...
			<div role="main" class="main">
				...
				<div class="owl-carousel owl-carousel-light owl-carousel-light-init-fadeIn owl-theme manual dots-inside dots-horizontal-center show-dots-hover show-dots-xs show-dots-sm show-dots-md full-width nav-inside nav-inside-edge show-nav-hover custom-carousel-arrows-style-1 mb-0" data-plugin-options="{'autoplayTimeout': 7000}" data-dynamic-height="['600px','600px','600px','500px','500px']" style="height: 600px;">
					<div class="owl-stage-outer">
						<div class="owl-stage">
							...
							<!-- Carousel Slide 1 -->
							<div class="owl-item position-relative overflow-hidden" style="background-image: url(<?php echo e(asset('html/img/demos/church/slides/3.jpg')); ?>); background-size: cover; background-position: center; background-position: center;">
									...
									<div class="row align-items-center justify-content-center h-100">
										<div class="col-lg-7">
											<div class="d-flex flex-column justify-content-center align-items-center text-center h-100">
												...
												<a href="<?php echo e(asset('html/demo-church-about-us.html')); ?>" class="btn btn-primary font-weight-bold btn-py-2 btn-px-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1250">LEARN MORE</a>
											</div>
										</div>
									</div>
								</div>
							...
							<!-- Carousel Slide 2 -->
							<div class="owl-item position-relative overflow-hidden" style="background-image: url(<?php echo e(asset('html/img/demos/church/slides/7.jpg')); ?>); background-size: cover; background-position: center; background-position: center;">
								<div class="container position-relative z-index-3 h-100">
									<div class="row align-items-center justify-content-center h-100">
										<div class="col-lg-7">
											<div class="d-flex flex-column justify-content-center align-items-center text-center h-100">
                            ...
                            <!-- Carousel Slide 2 -->
							<div class="owl-item position-relative overflow-hidden" style="background-image: url(<?php echo e(asset('html/img/demos/church/slides/5.jpg')); ?>); background-size: cover; background-position: center; background-position: center;">
								<div class="container position-relative z-index-3 h-100">
									<div class="row align-items-center justify-content-center h-100">
										<div class="col-lg-7">
											<div class="d-flex flex-column justify-content-center align-items-center text-center h-100">
					...
					<div class="container">
						<div class="row align-items-center">
							...
							<div class="col-lg-2 mt-4 mt-lg-0">
								<a href="<?php echo e(asset('html/demo-church-about-us.html')); ?>" class="btn btn-primary custom-btn-style-1 text-uppercase">Visitors Guide</a>
							</div>
						</div>
					</div>
				</section>
					...
					<div class="container">
						<div class="row justify-content-center text-center">
							<div class="col-md-8 col-xl-10">
								...
								<a href="<?php echo e(asset('html/demo-church-about-us.html')); ?>" class="btn btn-primary custom-btn-style-1 text-uppercase mt-4">Learn More</a>
							</div>
						</div>
					</div>
				</section>
							...
							<div class="col-lg-6 mb-4 mb-lg-0">
								...
								<article class="thumb-info custom-thumb-info custom-box-shadow">
									<span class="thumb-info-wrapper">
										<a href="<?php echo e(asset('html/demo-church-events-detail.html')); ?>">
									...
									<span class="thumb-info-caption">
										...
										<span class="thumb-info-caption-text">
											<h4 class="font-weight-bold mb-2">
												<a href="<?php echo e(asset('html/demo-church-events-detail.html')); ?>" class="text-decoration-none custom-secondary-font text-color-dark">
							...
							<div class="col-lg-6">
								...
								<article class="custom-post-event">
									...
									<div class="post-event-content custom-margin-1">
										...
										<h4 class="font-weight-bold">
											<a href="<?php echo e(asset('html/demo-church-events-detail.html')); ?>" class="text-decoration-none custom-secondary-font text-color-dark">Mauris ornare semeu lorem</a>
										</h4>
								...
								<article class="custom-post-event">
									...
									<div class="post-event-content custom-margin-1">
										...
										<h4 class="font-weight-bold">
											<a href="<?php echo e(asset('html/demo-church-events-detail.html')); ?>" class="text-decoration-none custom-secondary-font text-color-dark">Curabitur vehicula massa</a>
										</h4>
								...
								<a href="<?php echo e(asset('html/demo-church-events.html')); ?>" class="btn btn-primary custom-btn-style-1 text-uppercase custom-margin-1 mt-4">All Events</a>
							</div>
						</div>
					</div>
				</section>
							...
							<div class="col-md-10 col-lg-4 mb-4 mb-lg-0">
								<article class="custom-post-blog">
									<span class="thumb-info custom-thumb-info-2">
										<span class="thumb-info-wrapper">
											<a href="<?php echo e(asset('html/demo-church-blog-detail.html')); ?>">
										...
										<span class="thumb-info-caption custom-box-shadow">
											<span class="thumb-info-caption-text">
												<h4 class="font-weight-bold mb-4">
													<a href="<?php echo e(asset('html/demo-church-blog-detail.html')); ?>" class="text-decoration-none custom-secondary-font text-color-dark">
				...
				<section class="section section-no-border custom-position-relative custom-overflow-hidden p-0 m-0">
					<div class="custom-view-our-location text-center">
						<img src="<?php echo e(asset('html/img/demos/church/others/view-our-location.png')); ?>" alt />
					...
					<div class="row text-center">
						<div class="col">
							<a href="<?php echo e(asset('html/demo-church.html')); ?>" class="text-decoration-none">
								<img src="<?php echo e(asset('html/img/demos/church/logo-footer.png')); ?>" width="123" height="48" alt class="img-fluid custom-img-fluid-center" />
							</a>
						</div>
					</div>
					...
					<div class="row justify-content-center text-center">
						...
						<div class="col-lg-3">
							...
							<p class="alternative-font-4 text-3-5">
								...
								<a href="<?php echo e(asset('html/tel:+91123456789')); ?>" class="text-decoration-none custom-text-color-2">Phone : (123) 456-789</a></br>
								<a href="<?php echo e(asset('html/mail:mail@example.com')); ?>" class="text-decoration-none custom-text-color-2">Email : <span class="__cf_email__" data-cfemail="c9a4a8a0a589acb1a8a4b9a5ace7aaa6a4">[email&#160;protected]</span></a>
							</p>
						</div>
					</div>
					<hr class="solid tall custom-hr-color-1">
