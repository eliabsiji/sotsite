...
<head>
	...
	<body>
										...
										<div class="header-nav-main header-nav-main-square header-nav-main-dark-text header-nav-main-effect-1 header-nav-main-sub-effect-1">
											<nav class="collapse">
												<ul class="nav nav-pills" id="mainNav">
													<li>
														<a class="nav-link active" href="{{ asset('html/demo-church.html') }}">
															Home
														</a>
													</li>
													...
													<li>
														<a class="nav-link" href="{{ asset('html/demo-church-sermons.html') }}">
															Sermons
														</a>
													</li>
													<li>
														<a class="nav-link" href="{{ asset('html/demo-church-events.html') }}">
															Events
														</a>
													</li>
													<li>
														<a class="nav-link" href="{{ asset('html/demo-church-gallery.html') }}">
															Gallery
														</a>
													</li>
													<li>
			...
			<div role="main" class="main">
				...
				<div class="owl-carousel owl-carousel-light owl-carousel-light-init-fadeIn owl-theme manual dots-inside dots-horizontal-center show-dots-hover show-dots-xs show-dots-sm show-dots-md full-width nav-inside nav-inside-edge show-nav-hover custom-carousel-arrows-style-1 mb-0" data-plugin-options="{'autoplayTimeout': 7000}" data-dynamic-height="['600px','600px','600px','500px','500px']" style="height: 600px;">
					<div class="owl-stage-outer">
						<div class="owl-stage">
							...
							<!-- Carousel Slide 1 -->
							<div class="owl-item position-relative overflow-hidden" style="background-image: url({{ asset('html/img/demos/church/slides/3.jpg') }}); background-size: cover; background-position: center; background-position: center;">
							...
							<!-- Carousel Slide 2 -->
							<div class="owl-item position-relative overflow-hidden" style="background-image: url({{ asset('html/img/demos/church/slides/7.jpg') }}); background-size: cover; background-position: center; background-position: center;">
								<div class="container position-relative z-index-3 h-100">
									<div class="row align-items-center justify-content-center h-100">
										<div class="col-lg-7">
											<div class="d-flex flex-column justify-content-center align-items-center text-center h-100">
                            ...
                            <!-- Carousel Slide 2 -->
							<div class="owl-item position-relative overflow-hidden" style="background-image: url({{ asset('html/img/demos/church/slides/5.jpg') }}); background-size: cover; background-position: center; background-position: center;">
								<div class="container position-relative z-index-3 h-100">
									<div class="row align-items-center justify-content-center h-100">
										<div class="col-lg-7">
											<div class="d-flex flex-column justify-content-center align-items-center text-center h-100">
					...
					<div class="container">
						<div class="row justify-content-center text-center">
							<div class="col-md-8 col-xl-10">
								...
								<a href="{{ asset('html/demo-church-about-us.html') }}" class="btn btn-primary custom-btn-style-1 text-uppercase mt-4">Learn More</a>
							</div>
						</div>
					</div>
				</section>
							...
							<div class="col-lg-6 mb-4 mb-lg-0">
								...
								<article class="thumb-info custom-thumb-info custom-box-shadow">
									<span class="thumb-info-wrapper">
										<a href="{{ asset('html/demo-church-events-detail.html') }}">
									...
									<span class="thumb-info-caption">
										...
										<span class="thumb-info-caption-text">
											<h4 class="font-weight-bold mb-2">
												<a href="{{ asset('html/demo-church-events-detail.html') }}" class="text-decoration-none custom-secondary-font text-color-dark">
							...
							<div class="col-lg-6">
								...
								<article class="custom-post-event">
									...
									<div class="post-event-content custom-margin-1">
										...
										<h4 class="font-weight-bold">
											<a href="{{ asset('html/demo-church-events-detail.html') }}" class="text-decoration-none custom-secondary-font text-color-dark">Mauris ornare semeu lorem</a>
										</h4>
								...
								<article class="custom-post-event">
									...
									<div class="post-event-content custom-margin-1">
										...
										<h4 class="font-weight-bold">
											<a href="{{ asset('html/demo-church-events-detail.html') }}" class="text-decoration-none custom-secondary-font text-color-dark">Curabitur vehicula massa</a>
										</h4>
								...
								<a href="{{ asset('html/demo-church-events.html') }}" class="btn btn-primary custom-btn-style-1 text-uppercase custom-margin-1 mt-4">All Events</a>
							</div>
						</div>
					</div>
				</section>
				...
				<section class="section section-no-border custom-position-relative custom-overflow-hidden p-0 m-0">
					<div class="custom-view-our-location text-center">
						<img src="{{ asset('html/img/demos/church/others/view-our-location.png') }}" alt />
					...
					<div class="row text-center pb-5">
						<div class="col">
							<ul class="social-icons social-icons-clean custom-social-icons mb-3">
								...
								<li class="social-icons-twitter"><a href="{{ asset('html/http://www.twitter.com/') }}" target="_blank" title="Twitter"><i class="fab fa-twitter"></i></a></li>
		...
		<a class="demos-redirect" href="{{ asset('html/index-2.html#demos')}}" data-bs-toggle="tooltip" data-bs-animation="false" data-bs-placement="right" title="Demos"><img alt="Demos" src="{{ asset('html/img/icons/demos-redirect.png') }}" class="img-fluid" /></a>


		<!-- Vendor -->
		<script data-cfasync="false" src="{{ asset('html/../../../cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js')}}"></script>
		<script src="{{ asset('html/vendor/plugins/js/plugins.min.js')}}"></script>
		<script src="{{ asset('html/vendor/jquery.countdown/jquery.countdown.min.js')}}"></script>
		...
		<!-- Demo -->
		<script src="{{ asset('html/js/demos/demo-church.js')}}"></script>
